        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    }, 5000); // Задержка перед показом пятого блока
                }, 5000); // Задержка перед показом четвёртого блока
            }, 5000); // Задержка перед показом третьего блока
        }, 5000); // Задержка перед показом второго блока
    }
